...
CREATE TABLE `lookup_hospcode`  (
  ...
  INDEX `hospcode`(`hospcode` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `lookup_icd10`  (
  ...
  INDEX `icd10`(`icd10` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `lookup_ward`  (
  ...
  INDEX `ward`(`ward` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `main_setting`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `main_setting_name_unique`(`name` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of main_setting
-- ----------------------------
INSERT INTO `main_setting` VALUES (1, 'opoh_token', '5|arAFdKz8ZDzn7K6n8Zlqyg49CsM9QLymzDqWaoWA4bb7d115', NULL, '2026-05-18 08:52:42');
INSERT INTO `main_setting` VALUES (2, 'opoh_url', 'https://dcyasothon.moph.go.th/ysopod/web/api', NULL, '2026-05-18 08:51:12');
INSERT INTO `main_setting` VALUES (3, 'bed_qty', '60', NULL, '2026-05-18 09:02:24');
...
-- Records of sessions
-- ----------------------------
INSERT INTO `sessions` VALUES ('2bk8g7GFi7Hibk7ZkAkLLnvjz8KVcdOuvdI6RBCm', 1, '192.168.200.32', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36', '', 1779097380);
